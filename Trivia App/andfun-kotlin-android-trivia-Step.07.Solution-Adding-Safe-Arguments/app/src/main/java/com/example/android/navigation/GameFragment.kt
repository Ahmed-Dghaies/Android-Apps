...
/**
 * Game Fragment which displays the question in a random manner
 * @property Question which is a data class to represent the question
 * @property questions an array of possible questions
 * @property currentQuestion the question currently on display
 * @property answers the answers of a specific question
 * @property questionIndex number of right questions
 * @property numQuestions the total number of questions asked
 */
