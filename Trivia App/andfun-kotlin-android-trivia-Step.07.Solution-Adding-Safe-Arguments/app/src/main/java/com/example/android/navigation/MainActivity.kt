...
/**
 * Main Activity
 * @property drawerLayout which is the drawer that appears on the left of the screen
 * @property appBarConfiguration navigation bar configuration
 */
class MainActivity : AppCompatActivity() {
    ...
    /**
     * onSupportNavigateUp makes the app support the up navigation
     */
