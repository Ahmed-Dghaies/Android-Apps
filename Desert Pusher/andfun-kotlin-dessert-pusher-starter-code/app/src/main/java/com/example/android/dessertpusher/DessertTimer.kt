 ...
 * @property lifecycle the activity,s life cycle
 * @property secondsCount number of seconds passed
 * @property runnable used to create the runnable action which prints the log
 * @property handler cycle through the actions and command the runnable to execute
 *
 */
class DessertTimer (lifecycle: Lifecycle): LifecycleObserver {
    ...
    /**
     * starts the timer when on start is fulfilled
     */
    ...
    /**
     * stops the timer when on stop is fulfilled
     */
